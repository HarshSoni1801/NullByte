...
const solveDoubt = async (req, res) => {
   console.log("solve doubt called, req body: ", req.body);
    try {
        const ai = new GoogleGenAI({ apiKey: process.env.GEMENIS_API_KEY });
        const {messages,title,description,testCases,startCode,userCode,language}=req.body;
        console.log("Before generarting response");
